...
/**
 * This form of an Event is for the Update (patching) operation and, as such, all properties are optional, and consist of two groups (\&quot;can&#x27;t be changed\&quot;, and all the others where \&quot;at least one should be changed\&quot;).  The \&quot;can&#x27;t be changed\&quot; properties are - &#x27;id&#x27;, &#x27;updateToken&#x27;, &#x27;mbf&#x27;; if any of these are changed, the update/patch request will return a 400!
 */
...
public class PatchEvent extends AbstractAllEventProperties<PatchEvent> {
    @Override
    protected final AbstractAllEventPropertiesMD<PatchEvent> abstractAllEventPropertiesMD() {
